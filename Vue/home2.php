...
<div class="container">
    ...
    <div class="indices" data-level="<?php echo htmlspecialchars(($_POST['level'])); ?>" data-dimension="<?php echo htmlspecialchars(((int)$gridDimension+1)); ?>" data-name="<?php echo htmlspecialchars($gridName); ?>">
